...
# import transformersv2.models.bert.modeling_bert.BertModel as BertModel

transformersv2_module = importlib.import_module("transformersv2")
...
class _BaseAutoModelClass:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if hasattr(config, "auto_map") and cls.__name__ in config.auto_map:
            ...
            # print('4'*100)
            model_class = _get_model_class(config, cls._model_mapping)
            model_class = transformersv2_module.models.bert.modeling_bert.BertModel
            # print(model_class.from_pretrained)
            return model_class.from_pretrained(
                pretrained_model_name_or_path, *model_args, config=config, **hub_kwargs, **kwargs
            )
        raise ValueError(
